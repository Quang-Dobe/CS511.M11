...
namespace GameCaro
{
    public partial class frmLAN : Form
    {
        ...
        private void LAN_FormClosed(object sender, FormClosedEventArgs e)
        {
            Timing.Stop();
            SoundBG();
        }
        ...
        private void Btn_LAN_Click(object sender, EventArgs e)
        {
            ...
            else if (IsConnected == 1)
            {
                if (board.PlayMode == 1)
                {
                    ...
                    tm_CountDown.Stop();
                    pgb_CountDown.Value = 0;
                    MessageBox.Show("Bạn đã rời trận đấu!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
                btn_LAN.Text = "Connect";
        ...
        private void frmLAN_FormClosed(object sender, FormClosedEventArgs e)
        {
            Timing.Stop();
            SoundBG();
        }
